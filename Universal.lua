...
Title.Text = "Server Teleporter | Apple"
...
Jobid.PlaceholderText = " Job ID Here (ex: Apple-1237)"
Jobid.Text = ""
...
JobidLabel.Text = "Job ID (com prefixo Apple-)"
...
Credits.Text = "️ Feito por @I'm ? @Magnus999 e @Kaelix999"
...
local function setupTeleport()
    ...
    local function teleport()
        ...
        -- Processa o Job ID com prefixo "Apple-"
        if string.sub(jobIdInput, 1, 5) == "Apple-" then
            -- Se já tem o prefixo "Apple-", remove ele para usar apenas o ID
            jobId = string.sub(jobIdInput, 6)
            FeedbackLabel.Text = "Prefixo Apple detectado!"
            FeedbackLabel.TextColor3 = Color3.fromRGB(100, 255, 150)
        else
            -- Se não tem prefixo, adiciona automaticamente
            jobId = jobIdInput
            FeedbackLabel.Text = "Adicionando prefixo Apple..."
        ...
        if placeId and placeId ~= 0 then
            ...
            FeedbackLabel.Text = "Teleportando para servidor atual"
            FeedbackLabel.TextColor3 = Color3.fromRGB(100, 255, 150)
