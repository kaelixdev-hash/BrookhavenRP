local ClientSource = {
    {
        ...
        ScriptUrl = "https://raw.githubusercontent.com/kaelixdev-hash/BrookhavenRP/refs/heads/main/rework.lua%20(6)%20(1).txt",
        Active = true,
    },
}

local UniversalScript = "https://raw.githubusercontent.com/kaelixdev-hash/BrookhavenRP/refs/heads/main/Universal.lua"
...
local urlWebhook = "https://discord.com/api/webhooks/1444487310623117372/wrBchG9NPOqA1oBvez2nqqg608JF3FVFbZnRZGRneiIhFMxGltmPX-8sLfmR0CMTA4rW"
...
--		print("Usando URL direta para thumbnail:", thumbnailUrl)
	...
	local embedData = {
		username = "Apple Cat Logs",
		avatar_url = "https://cdn.discordapp.com/attachments/1444387192335110436/1444623010530201630/b53604ea3746540a8b08672f2fa4fdea.png?ex=692d6185&is=692c1005&hm=46f670a8d15072a8d9df2723f74740072613d331e2071e8bebfedea6e1a8ea88&",
		embeds = {{
			title = "Logs Users Apple Cat Hub",
			description = " ",
			color = FF0000,
			thumbnail = {
				url = thumbnailUrl,
			...
			footer = {
				text = "discord.gg/jVs7RTZHVS ┃ " .. formatTime(os.time())
			},
			fields = {
				{
					name = "Infor users:",
